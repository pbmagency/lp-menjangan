...
<div id="page" data-lg="en" style="background: var(--color-bg); color: var(--color-text); font-family: var(--font-body)">
  ...
  <section id="top" style="position: relative; min-height: min(78vh, 680px); display: grid; align-items: center; overflow: hidden">
    ...
    <div style="position: relative; max-width: 1160px; width: 100%; margin: 0 auto; padding: 84px 24px 56px; color: var(--color-bg)">
      ...
      <p data-l="en" style="max-width: 50ch; font-size: 16px; line-height: 1.6; color: #ffffff; text-shadow: 0 1px 12px rgba(15, 26, 48, 0.5)">Swim, snorkel, or dive among vibrant coral reefs and marine life at Menjangan Island, with everything arranged for you from Banyuwedang Harbour.</p>
      <p data-l="id" style="max-width: 50ch; font-size: 16px; line-height: 1.6; color: #ffffff; text-shadow: 0 1px 12px rgba(15, 26, 48, 0.5)">Berenang, snorkeling, atau diving di antara terumbu karang dan biota laut Pulau Menjangan, dengan semuanya kami siapkan dari Pelabuhan Banyuwedang.</p>
