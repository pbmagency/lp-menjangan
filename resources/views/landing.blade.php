...
<div id="page" data-lg="en" style="background: var(--color-bg); color: var(--color-text); font-family: var(--font-body)">
    ...
    <div style="position: relative; max-width: 1160px; width: 100%; margin: 0 auto; padding: 84px 24px 56px; color: var(--color-bg)">
      <div style="display: inline-flex; align-items: center; gap: 12px; border-radius: 999px; padding: 6px 14px; margin-bottom: 18px; border-width: 1px; border-style: solid; border-color: var(--color-bg)">
        ...
        <span style="display: flex; align-items: center">
          <img src="https://lh3.googleusercontent.com/a-/ALV-UjW-6b9dWJYlqucqyOG9MKBwePsZDQk6FMk2lCZxhY9Z1lN2FcE=w80-h80-c-rp-mo-br100" alt="" loading="lazy" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid #ffffff; object-fit: cover; flex: none">
          <img src="https://lh3.googleusercontent.com/a-/ALV-UjUe8F2EkfzifVFcolV6LH52P7urkwIJt9u-9YQRxgiRzuqEgGSdQw=w80-h80-c-rp-mo-ba12-br100" alt="" loading="lazy" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid #ffffff; object-fit: cover; flex: none; margin-left: -8px">
          <img src="https://lh3.googleusercontent.com/a-/ALV-UjWgkfdm69EosFB2aGTOvOG8fJAhDiDs-6kjQHwAfen3aB7WXMDY-g=w80-h80-c-rp-mo-br100" alt="" loading="lazy" style="width: 24px; height: 24px; border-radius: 50%; border: 2px solid #ffffff; object-fit: cover; flex: none; margin-left: -8px">
        </span>
      </div>
      ...
      <p data-l="en" style="max-width: 50ch; font-size: 16px; line-height: 1.6; color: #ffffff; text-shadow: 0 1px 12px rgba(15, 26, 48, 0.5)">DISCOVER THE BEST OF MENJANGAN ISLAND: Explore crystal-clear waters, vibrant coral reefs, and incredible marine life with Menjangan’s most trusted local snorkeling operator.</p>
      <p data-l="id" style="max-width: 50ch; font-size: 16px; line-height: 1.6; color: #ffffff; text-shadow: 0 1px 12px rgba(15, 26, 48, 0.5)">TEMUKAN KEINDAHAN TERBAIK PULAU MENJANGAN: Jelajahi perairan sebening kristal, terumbu karang yang hidup, dan biota laut menakjubkan bersama operator snorkeling lokal paling tepercaya di Menjangan.</p>
      <div style="display: grid; justify-items: start; gap: 12px; margin: 24px 0 22px">
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20book%20a%20trip%20to%20Menjangan%20Island.%20Please%20send%20me%20the%20price%20and%20availability." target="_blank" rel="noopener" style="padding: 14px 24px; font-size: 15px">
  ...
  <section style="padding: 56px 24px; border-top: 1px solid var(--color-divider)">
    ...
    <div style="position: relative; min-height: 620px; overflow: hidden">
      <img src="https://menjanganislandtrip.com/wp-content/uploads/2026/08/GOPR7894-scaled-1.jpg" alt="Coral garden in clear shallow water" loading="lazy" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover">
    ...
    <div style="padding: clamp(36px, 5vw, 72px); display: grid; align-content: center; gap: 24px">
      <div>
        ...
        <h2 style="font-size: clamp(30px, 3.4vw, 44px); text-transform: uppercase; max-width: 24ch; margin: 0 0 16px">
          <span data-l="en">Snorkeling Menjangan Island: Full-Day Trip, Everything Included</span><span data-l="id">Snorkeling Pulau Menjangan: Trip Sehari, Semua Termasuk</span>
        </h2>
      </div><div>
        <p data-l="en" style="font-size: 16px; color: var(--color-neutral-800); max-width: 52ch">One message, a fast reply, a day on Bali’s clearest reef.</p>
        <p data-l="id" style="font-size: 16px; color: var(--color-neutral-800); max-width: 52ch">Satu pesan, dibalas cepat, satu hari di reef terjernih Bali.</p>
      </div>
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 24px">
        <div>
          ...
          <ul data-l="en" style="margin: 0; padding-left: 18px; display: grid; gap: 7px; font-size: 15px; color: var(--color-neutral-800)">
            <li>Two snorkeling points inside the national park</li>
            <li>± 4 hours · 09:00 daily, or private 07:00–15:00</li>
            <li>Guide in the water with you</li>
            <li>All levels, non-swimmers welcome</li>
          </ul>
          <ul data-l="id" style="margin: 0; padding-left: 18px; display: grid; gap: 7px; font-size: 15px; color: var(--color-neutral-800)">
            <li>Dua titik snorkeling di dalam taman nasional</li>
            <li>± 4 jam · 09.00 harian, atau privat 07.00–15.00</li>
            <li>Guide mendampingi di air</li>
            <li>Semua level, non-perenang bisa ikut</li>
          </ul>
        </div>
        <div>
      ...
      <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 18px">
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20book%20the%20Snorkeling%20Menjangan%20Island%20trip.%20Please%20send%20me%20the%20price%20and%20availability." target="_blank" rel="noopener" style="padding: 14px 24px; font-size: 15px">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 22px; height: 22px; flex: none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.75 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C21.92 6.45 17.5 2 12.04 2zm0 18.13c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.16 8.16 0 0 1-1.25-4.32c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.41a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.21-8.17 8.21zm4.79-5.85c-.26-.13-1.55-.76-1.79-.85-.24-.09-.41-.13-.59.13-.17.26-.67.85-.83 1.02-.15.18-.3.19-.57.06-.26-.13-.99-.37-1.88-1.16-.7-.62-1.17-1.39-1.3-1.65-.13-.26-.02-.4.11-.53.13-.13.26-.3.4-.46.13-.15.17-.26.26-.44.09-.17.04-.33-.03-.46-.06-.13-.59-1.41-.8-1.93-.21-.5-.43-.44-.59-.45h-.5c-.17 0-.45.06-.69.32-.24.26-.91.88-.91 2.16s.93 2.51 1.06 2.69c.13.17 1.83 2.92 4.44 3.99.62.27 1.1.43 1.48.55.62.2 1.19.17 1.64.1.5-.07 1.54-.63 1.76-1.24.22-.61.22-1.13.15-1.24-.06-.11-.24-.18-.5-.31z"></path></svg>
    ...
    <div style="padding: clamp(36px, 5vw, 72px); display: grid; align-content: center; gap: 24px">
      <div>
        ...
        <h2 style="font-size: clamp(30px, 3.4vw, 44px); text-transform: uppercase; max-width: 24ch; margin: 0 0 16px">
          <span data-l="en">Scuba Diving Menjangan Island: 11 Dive Sites, Gentle Currents, Up to 25m</span><span data-l="id">Scuba Diving Pulau Menjangan: 11 Dive Site, Arus Tenang, Hingga 25m</span>
        </h2>
      </div><div>
        <p data-l="en" style="font-size: 16px; color: var(--color-neutral-800); max-width: 52ch">A wall dive island: the reef drops past 25 m.</p>
        <p data-l="id" style="font-size: 16px; color: var(--color-neutral-800); max-width: 52ch">Pulau wall dive: reef menurun melewati 25 m.</p>
        <ul data-l="en" style="margin: 0; padding-left: 18px; display: grid; gap: 7px; font-size: 15px; color: var(--color-neutral-800)">
            <li>Two dives, 3–25 m, visibility to 30 m</li>
            <li>11 sites, chosen that morning</li>
            <li>± 4 hours, surface interval on board</li>
            <li>Open Water and above</li>
          </ul>
        <ul data-l="id" style="margin: 0; padding-left: 18px; display: grid; gap: 7px; font-size: 15px; color: var(--color-neutral-800)">
            <li>Dua kali dive, 3–25 m, visibility hingga 30 m</li>
            <li>11 dive site, dipilih pagi itu</li>
            <li>± 4 jam, surface interval di boat</li>
            <li>Open Water ke atas</li>
          </ul>
      </div>
      <div>
        <h4 style="margin: 0 0 10px; text-transform: uppercase; letter-spacing: 0.04em"><span data-l="en">Included</span><span data-l="id">Termasuk</span></h4>
      ...
      <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 18px">
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20book%20the%20Scuba%20Diving%20Menjangan%20Island%20trip.%20Please%20send%20me%20the%20price%20and%20availability." target="_blank" rel="noopener" style="padding: 14px 24px; font-size: 15px">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 22px; height: 22px; flex: none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.75 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C21.92 6.45 17.5 2 12.04 2zm0 18.13c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.16 8.16 0 0 1-1.25-4.32c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.41a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.21-8.17 8.21zm4.79-5.85c-.26-.13-1.55-.76-1.79-.85-.24-.09-.41-.13-.59.13-.17.26-.67.85-.83 1.02-.15.18-.3.19-.57.06-.26-.13-.99-.37-1.88-1.16-.7-.62-1.17-1.39-1.3-1.65-.13-.26-.02-.4.11-.53.13-.13.26-.3.4-.46.13-.15.17-.26.26-.44.09-.17.04-.33-.03-.46-.06-.13-.59-1.41-.8-1.93-.21-.5-.43-.44-.59-.45h-.5c-.17 0-.45.06-.69.32-.24.26-.91.88-.91 2.16s.93 2.51 1.06 2.69c.13.17 1.83 2.92 4.44 3.99.62.27 1.1.43 1.48.55.62.2 1.19.17 1.64.1.5-.07 1.54-.63 1.76-1.24.22-.61.22-1.13.15-1.24-.06-.11-.24-.18-.5-.31z"></path></svg>
    ...
    <div style="position: relative; min-height: 620px; overflow: hidden">
      <img src="https://menjanganislandtrip.com/wp-content/uploads/2026/08/GOPR9548-scaled-1.jpg" alt="Diver along the reef wall at Menjangan" loading="lazy" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover">
    ...
    <div style="position: relative; min-height: 620px; overflow: hidden">
      <img src="https://menjanganislandtrip.com/wp-content/uploads/2026/08/GOPR7843-scaled-1.jpg" alt="Shallow reef in clear water" loading="lazy" style="position: absolute; inset: 0; width: 100%; height: 100%; object-fit: cover">
    ...
    <div style="padding: clamp(36px, 5vw, 72px); display: grid; align-content: center; gap: 24px">
      <div>
        ...
        <h2 style="font-size: clamp(30px, 3.4vw, 44px); text-transform: uppercase; max-width: 24ch; margin: 0 0 16px">
          <span data-l="en">Never Dived Before? Try Scuba Diving at Menjangan, No Certification Needed</span><span data-l="id">Belum Pernah Diving? Try Scuba Diving di Menjangan, Tanpa Sertifikasi</span>
        </h2>
      </div><div>
      ...
      <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 18px">
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20book%20the%20Try%20Scuba%20Diving%20experience%20at%20Menjangan.%20Please%20send%20me%20the%20price%20and%20availability." target="_blank" rel="noopener" style="padding: 14px 24px; font-size: 15px">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 22px; height: 22px; flex: none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.75 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C21.92 6.45 17.5 2 12.04 2zm0 18.13c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.16 8.16 0 0 1-1.25-4.32c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.41a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.21-8.17 8.21zm4.79-5.85c-.26-.13-1.55-.76-1.79-.85-.24-.09-.41-.13-.59.13-.17.26-.67.85-.83 1.02-.15.18-.3.19-.57.06-.26-.13-.99-.37-1.88-1.16-.7-.62-1.17-1.39-1.3-1.65-.13-.26-.02-.4.11-.53.13-.13.26-.3.4-.46.13-.15.17-.26.26-.44.09-.17.04-.33-.03-.46-.06-.13-.59-1.41-.8-1.93-.21-.5-.43-.44-.59-.45h-.5c-.17 0-.45.06-.69.32-.24.26-.91.88-.91 2.16s.93 2.51 1.06 2.69c.13.17 1.83 2.92 4.44 3.99.62.27 1.1.43 1.48.55.62.2 1.19.17 1.64.1.5-.07 1.54-.63 1.76-1.24.22-.61.22-1.13.15-1.24-.06-.11-.24-.18-.5-.31z"></path></svg>
    ...
    <div style="position: relative; max-width: 1160px; width: 100%; margin: 0 auto; padding: 60px 24px; color: var(--color-bg)">
      ...
      <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20check%20availability%20for%20a%20Menjangan%20Island%20trip." target="_blank" rel="noopener" style="margin-top: 18px; padding: 13px 22px; font-size: 15px">
    ...
    <div style="max-width: 1160px; margin: 0 auto">
      ...
      <div id="reviews-fallback" style="display: grid; gap: 22px">
        ...
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20read%20your%20reviews%20and%20would%20like%20to%20book%20a%20Menjangan%20Island%20trip.%20Please%20send%20me%20the%20price%20and%20availability." target="_blank" rel="noopener" style="display: inline-flex; align-items: center; gap: 10px; padding: 15px 26px; font-size: 15px">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 22px; height: 22px; flex: none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.75 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C21.92 6.45 17.5 2 12.04 2zm0 18.13c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.16 8.16 0 0 1-1.25-4.32c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.41a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.21-8.17 8.21zm4.79-5.85c-.26-.13-1.55-.76-1.79-.85-.24-.09-.41-.13-.59.13-.17.26-.67.85-.83 1.02-.15.18-.3.19-.57.06-.26-.13-.99-.37-1.88-1.16-.7-.62-1.17-1.39-1.3-1.65-.13-.26-.02-.4.11-.53.13-.13.26-.3.4-.46.13-.15.17-.26.26-.44.09-.17.04-.33-.03-.46-.06-.13-.59-1.41-.8-1.93-.21-.5-.43-.44-.59-.45h-.5c-.17 0-.45.06-.69.32-.24.26-.91.88-.91 2.16s.93 2.51 1.06 2.69c.13.17 1.83 2.92 4.44 3.99.62.27 1.1.43 1.48.55.62.2 1.19.17 1.64.1.5-.07 1.54-.63 1.76-1.24.22-.61.22-1.13.15-1.24-.06-.11-.24-.18-.5-.31z"></path></svg>
    ...
    <div style="max-width: 1160px; margin: 0 auto">
      ...
      <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 14px; margin-top: 28px">
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20book%20a%20trip%20to%20Menjangan%20Island.%20Please%20send%20me%20the%20price%20and%20availability." target="_blank" rel="noopener" style="padding: 15px 26px; font-size: 16px">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 22px; height: 22px; flex: none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.75 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C21.92 6.45 17.5 2 12.04 2zm0 18.13c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.16 8.16 0 0 1-1.25-4.32c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.41a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.21-8.17 8.21zm4.79-5.85c-.26-.13-1.55-.76-1.79-.85-.24-.09-.41-.13-.59.13-.17.26-.67.85-.83 1.02-.15.18-.3.19-.57.06-.26-.13-.99-.37-1.88-1.16-.7-.62-1.17-1.39-1.3-1.65-.13-.26-.02-.4.11-.53.13-.13.26-.3.4-.46.13-.15.17-.26.26-.44.09-.17.04-.33-.03-.46-.06-.13-.59-1.41-.8-1.93-.21-.5-.43-.44-.59-.45h-.5c-.17 0-.45.06-.69.32-.24.26-.91.88-.91 2.16s.93 2.51 1.06 2.69c.13.17 1.83 2.92 4.44 3.99.62.27 1.1.43 1.48.55.62.2 1.19.17 1.64.1.5-.07 1.54-.63 1.76-1.24.22-.61.22-1.13.15-1.24-.06-.11-.24-.18-.5-.31z"></path></svg>
...
<details style="background: #ffffff; border: 1px solid var(--color-divider); border-radius: 8px; box-shadow: 0 1px 3px rgba(15, 26, 48, 0.06); padding: 0; margin-bottom: 12px">
    ...
    <div style="max-width: 1160px; margin: 0 auto">
      ...
      <div style="display: flex; flex-wrap: wrap; align-items: center; gap: 14px; margin-top: 26px">
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20am%20staying%20in%20...%20Could%20you%20help%20me%20plan%20the%20timing%20for%20a%20Menjangan%20trip%3F" target="_blank" rel="noopener" style="padding: 15px 26px; font-size: 16px">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 22px; height: 22px; flex: none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.75 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C21.92 6.45 17.5 2 12.04 2zm0 18.13c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.16 8.16 0 0 1-1.25-4.32c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.41a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.21-8.17 8.21zm4.79-5.85c-.26-.13-1.55-.76-1.79-.85-.24-.09-.41-.13-.59.13-.17.26-.67.85-.83 1.02-.15.18-.3.19-.57.06-.26-.13-.99-.37-1.88-1.16-.7-.62-1.17-1.39-1.3-1.65-.13-.26-.02-.4.11-.53.13-.13.26-.3.4-.46.13-.15.17-.26.26-.44.09-.17.04-.33-.03-.46-.06-.13-.59-1.41-.8-1.93-.21-.5-.43-.44-.59-.45h-.5c-.17 0-.45.06-.69.32-.24.26-.91.88-.91 2.16s.93 2.51 1.06 2.69c.13.17 1.83 2.92 4.44 3.99.62.27 1.1.43 1.48.55.62.2 1.19.17 1.64.1.5-.07 1.54-.63 1.76-1.24.22-.61.22-1.13.15-1.24-.06-.11-.24-.18-.5-.31z"></path></svg>
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(230px, 1fr)); grid-auto-rows: 210px; gap: 2px; background: var(--color-neutral-300); background: var(--color-accent-100)">
      <img fetchpriority="high" src="https://menjanganislandtrip.com/wp-content/uploads/2026/08/518311948_739445245713673_2929780841752963449_n.jpg" alt="Our boat on the way to Menjangan Island" decoding="async" style="grid-column: span 2; grid-row: span 2; width: 100%; height: 100%; object-fit: cover; min-width: 0">
      <img fetchpriority="high" src="https://menjanganislandtrip.com/wp-content/uploads/2026/08/519396628_743465071978357_2561587557975164201_n.jpg" alt="Guests in the water with the guide" decoding="async" style="width: 100%; height: 100%; object-fit: cover; background: var(--color-accent-100); min-width: 0">
      <img fetchpriority="high" src="https://menjanganislandtrip.com/wp-content/uploads/2024/02/Anemone-fish-Menjangan-Island.jpg" alt="Anemone fish" decoding="async" style="width: 100%; height: 100%; object-fit: cover; background: var(--color-accent-100); min-width: 0">
      <img fetchpriority="high" src="https://menjanganislandtrip.com/wp-content/uploads/2024/02/Colorful-coral-Menjangan-Island.jpg" alt="Colourful coral" decoding="async" style="width: 100%; height: 100%; object-fit: cover; background: var(--color-accent-100); min-width: 0">
      <img fetchpriority="high" src="https://menjanganislandtrip.com/wp-content/uploads/2024/02/Turtles-Menjangan-Island.jpg" alt="Turtle over the reef" decoding="async" style="width: 100%; height: 100%; object-fit: cover; background: var(--color-accent-100); min-width: 0">
      <img fetchpriority="high" src="https://menjanganislandtrip.com/wp-content/uploads/2024/02/Tons-of-fishes-At-Menjangan-Island.jpg" alt="Schools of fish" decoding="async" style="grid-column: span 2; width: 100%; height: 100%; object-fit: cover; min-width: 0">
      ...
      <img fetchpriority="high" src="_2172056_11zon.webp" alt="Menjangan Island scenery" decoding="async" style="width: 100%; height: 100%; object-fit: cover; background: var(--color-accent-100); min-width: 0">
    </div>
  </section>
    ...
    <div style="position: relative; max-width: 1160px; margin: 0 auto; padding: 92px 24px; text-align: center; color: var(--color-bg)">
      ...
      <div style="display: flex; flex-wrap: wrap; gap: 12px; justify-content: center">
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20book%20the%20Snorkeling%20Menjangan%20Island%20trip." target="_blank" rel="noopener" style="padding: 14px 24px; font-size: 15px">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 22px; height: 22px; flex: none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.75 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C21.92 6.45 17.5 2 12.04 2zm0 18.13c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.16 8.16 0 0 1-1.25-4.32c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.41a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.21-8.17 8.21zm4.79-5.85c-.26-.13-1.55-.76-1.79-.85-.24-.09-.41-.13-.59.13-.17.26-.67.85-.83 1.02-.15.18-.3.19-.57.06-.26-.13-.99-.37-1.88-1.16-.7-.62-1.17-1.39-1.3-1.65-.13-.26-.02-.4.11-.53.13-.13.26-.3.4-.46.13-.15.17-.26.26-.44.09-.17.04-.33-.03-.46-.06-.13-.59-1.41-.8-1.93-.21-.5-.43-.44-.59-.45h-.5c-.17 0-.45.06-.69.32-.24.26-.91.88-.91 2.16s.93 2.51 1.06 2.69c.13.17 1.83 2.92 4.44 3.99.62.27 1.1.43 1.48.55.62.2 1.19.17 1.64.1.5-.07 1.54-.63 1.76-1.24.22-.61.22-1.13.15-1.24-.06-.11-.24-.18-.5-.31z"></path></svg>Snorkeling</a>
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20book%20the%20Scuba%20Diving%20Menjangan%20Island%20trip." target="_blank" rel="noopener" style="padding: 14px 24px; font-size: 15px">
          <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="width: 22px; height: 22px; flex: none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.46 1.32 4.96L2 22l5.25-1.38a9.9 9.9 0 0 0 4.75 1.21h.01c5.46 0 9.91-4.45 9.91-9.91C21.92 6.45 17.5 2 12.04 2zm0 18.13c-1.5 0-2.96-.4-4.24-1.16l-.3-.18-3.15.83.84-3.07-.2-.32a8.16 8.16 0 0 1-1.25-4.32c0-4.54 3.7-8.23 8.24-8.23 2.2 0 4.27.86 5.82 2.41a8.18 8.18 0 0 1 2.41 5.83c0 4.54-3.7 8.21-8.17 8.21zm4.79-5.85c-.26-.13-1.55-.76-1.79-.85-.24-.09-.41-.13-.59.13-.17.26-.67.85-.83 1.02-.15.18-.3.19-.57.06-.26-.13-.99-.37-1.88-1.16-.7-.62-1.17-1.39-1.3-1.65-.13-.26-.02-.4.11-.53.13-.13.26-.3.4-.46.13-.15.17-.26.26-.44.09-.17.04-.33-.03-.46-.06-.13-.59-1.41-.8-1.93-.21-.5-.43-.44-.59-.45h-.5c-.17 0-.45.06-.69.32-.24.26-.91.88-.91 2.16s.93 2.51 1.06 2.69c.13.17 1.83 2.92 4.44 3.99.62.27 1.1.43 1.48.55.62.2 1.19.17 1.64.1.5-.07 1.54-.63 1.76-1.24.22-.61.22-1.13.15-1.24-.06-.11-.24-.18-.5-.31z"></path></svg>Scuba Diving</a>
        <a class="btn btn-primary" href="https://wa.me/6281238578042?text=Hello%2C%20I%20would%20like%20to%20book%20the%20Try%20Scuba%20Diving%20experience%20at%20Menjangan." target="_blank" rel="noopener" style="padding: 14px 24px; font-size: 15px">
    ...
    <div style="max-width: 1160px; margin: 0 auto; display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 32px">
      <div>
        ...
        <div style="display: grid; gap: 6px; font-size: 14px">
          <a href="https://wa.me/6281238578042" target="_blank" rel="noopener" style="color: var(--color-accent-700)">WhatsApp +62 812 3857 8042</a>
