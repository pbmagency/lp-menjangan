...
const faqs: { category: string; q: string; a: string; node?: ReactNode }[] = [
    ...
    },
    {
        ...
        a: 'Garansi mengulang 1 bulan berlaku khusus untuk Paket Bundling. Jika setelah mengikuti program secara penuh dan konsisten skor kamu belum mencapai 500, kamu bisa claim garansi.',
    },
    {
        category: 'Pendaftaran & Pembayaran',
